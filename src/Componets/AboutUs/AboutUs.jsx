        ...
        >
          ...
          <Box sx={{ flex: 1 }}>
            ...
            <Typography variant="body1" sx={{ mt: 1, lineHeight: 1.6 }}>
              ...
              recruitment solutions, recognized for our commitment to
          ...
          >
            ...
            <Box sx={{ maxWidth: 300 }}>
              ...
              <Typography variant="body2" sx={{ mt: 1 }}>
                Leveraging cutting-edge recruitment techniques and a vast
                network of candidates, we help businesses find top talent
                across office-based roles.
              </Typography>
            </Box>
            ...
            <Box sx={{ maxWidth: 300 }}>
              ...
              <Typography variant="body2" sx={{ mt: 1 }}>
                Our commitment to excellence doesn’t end once a placement is
                made. We provide ongoing support to ensure long-term success.
              </Typography>
            </Box>
          </Box>
        </Box>
