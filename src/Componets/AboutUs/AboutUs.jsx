...
>>>>>>> Stashed changes
      ...
      {/* About Section */}
      <Box sx={{ display: "flex", flexDirection: { xs: "column", md: "row" }, alignItems: "center", gap: 4, mt: 5 }}>
        <Box sx={{ flex: 1, px: 8 }}>
        ...
        <Box sx={{ flex: 1, display: "flex", justifyContent: "center" }}>
          <img src={Img} alt="Office Team Working" style={{ width: "100%", maxWidth: "500px", borderRadius: "8px" }} loading="lazy" />
        </Box>
      </Box>

      {/* Our Services Section */}
      <Box sx={{ backgroundColor: "#150AFF", color: "white", py: 5, mt: 5, borderRadius: "8px" }}>
        <Typography variant="h4" fontWeight="bold" align="center" gutterBottom>
          OUR SERVICES
        </Typography>
        <Box sx={{ display: "flex", flexDirection: { xs: "column", md: "row" }, justifyContent: "space-around", textAlign: "center", gap: 4, mt: 3 }}>
          <Box sx={{ maxWidth: 300 }}>
            ...
            <Typography variant="body2" sx={{ mt: 1 }}>
              ...
              of candidates, we help businesses find top talent across office-based roles.
            </Typography>
          </Box>
          <Box sx={{ maxWidth: 300 }}>
