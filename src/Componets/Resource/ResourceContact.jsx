    ...
    <section className="w-full px-4 py-16 bg-white text-center">
      ...
      <div className="mt-20 text-center">
        ...
        <div className="mt-8">
          ...
          >
            <p className="mr-2 text-sm sm:text-base md:text-lg">
              Open today{" "}
              <span className="text-blue-700 font-medium">{hours[today]}</span>
            </p>
            {showHours ? (
              <ChevronUp className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-gray-600" />
            ) : (
              <ChevronDown className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-gray-600" />
            )}
          </div>
