        ...
        <div className="w-full mx-auto">
            ...
            <div className="bg-white container rounded-lg flex flex-col md:flex-row w-full mx-auto mb-8">
                ...
                <div className="md:w-1/2 p-4 px-12">
                    ...
                    <p className="text-gray-600 mb-2">Intelcom | Dragonfly</p>
                    ...
                    <p className="text-sm text-gray-600 mb-2">
                        Ride the next mile with us! Why choose Intelcom and become one of our Operations Supervisors?
                    </p>
                    <ul className="list-disc list-inside text-sm text-gray-600 mb-4">
                        ...
                        <li>Thrive in a fast-paced environment with quick decision-making</li>
                        <li>Participate in the development and implementation of procedures</li>
                    ...
                    <h4 className="text-md font-medium mb-2">About Intelcom</h4>
                    <p className="text-sm text-gray-600 mb-4">
                        Intelcom is a leading last-mile carrier in the e-commerce sector. Our teams across Canada, along with our network of independent contractors, contribute to Intelcom’s daily operations. Our goal is simple: in a constantly evolving business sector, we don’t just follow, we get ahead.
                    </p>
...
export default KsOperationsSupervisor