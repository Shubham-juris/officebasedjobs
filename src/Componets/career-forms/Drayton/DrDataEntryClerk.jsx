      ...
      <div className="bg-white container rounded-lg flex flex-col md:flex-row w-full mx-auto mb-8">
        ...
        <div className="md:w-1/2 p-4 px-12">
          ...
          <ul className="list-disc list-inside text-sm text-gray-600 mb-4">
            <li>Pay: $24.04 an hour</li>
            <li>Job type: Permanent, Full-time, Part-time</li>
          ...
          <ul className="list-disc list-inside text-sm text-gray-600 mb-4">
            ...
            <li>Classify, label and store diskettes/ disks and tapes of data</li>
            <li>Create digital records using a scanner</li>
