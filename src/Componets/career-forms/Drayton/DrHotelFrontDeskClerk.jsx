    ...
    <div className="w-full mx-auto">
      ...
      <div className="bg-white container rounded-lg flex flex-col md:flex-row w-full mx-auto mb-8">
        ...
        <div className="md:w-1/2 p-4 px-12">
          ...
          <p className="text-gray-600 mb-2">Service Plus Inn & Suites</p>
          <p className="text-gray-600 mb-2">Drayton Valley, AB</p>

          <h3 className="text-lg font-semibold mb-2">Job Details</h3>
          <ul className="list-disc list-inside text-sm text-gray-600 mb-4">
            <li>Pay: $18 an hour</li>
          ...
          <h4 className="text-md font-medium mb-2">Work Setting</h4>
          <ul className="list-disc list-inside text-sm text-gray-600 mb-4">
          ...
          <ul className="list-disc list-inside text-sm text-gray-600 mb-4">
            <li>Register arriving guests and assign rooms</li>
            <li>Process group arrivals and departures</li>
            <li>Take, cancel and change room reservations</li>
            <li>Provide information on hotel facilities and services</li>
            <li>Provide general information about points of interest in the area</li>
            <li>Process guests' departures, calculate charges and receive payments</li>
            <li>Follow emergency and safety procedures</li>
            <li>Clerical duties (i.e. faxing, filing, photocopying)</li>
          </ul>
          ...
          <ul className="list-disc list-inside text-sm text-gray-600 mb-4">
            ...
            <li>Hours: 30 to 35 hours per week</li>
          </ul>
        </div>
...
export default HotelFrontDeskClerk;
